...
public class ConfigsHandler {
    ...
    public static Config[] configsArray = new Config[]{
            ...
            new ConfigToggle("War", "Outline at Soonest War", "Enabled", "outlineSoonestWarTerr"),
            new ConfigToggle("War", "Highlight floor in territory outlines (may reduce FPS)", "Disabled", "highlightFloor"),
